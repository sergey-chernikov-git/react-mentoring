import  { movieReducer } from '../src/store/reducers'
import  { GET_MOVIES, GET_MOVIE, ADD_MOVIE, DEL_MOVIE, EDIT_MOVIE, FETCH_ERROR } from '../src/util/consts/consts'

import { getGenresList, getSortList } from '../src/util/dictionary/dictionary';
